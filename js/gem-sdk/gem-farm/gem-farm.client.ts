...
export class GemFarmClient extends GemBankClient {
  ...
  async initFarmer(
    ...
    const txSig = await this.farmProgram.instruction.initFarmer({
      accounts: {
        farm,
        farmer,
        identity: identityPk,
  ...
  async stakeCommon(
    ...
    if (unstake) {
      ...
      txSig = await this.farmProgram.instruction.unstake(
        farmAuthBump,
        farmTreasuryBump,
        farmerBump,
        skipRewards,
      ...
      txSig = await this.farmProgram.instruction.stake(
        farmAuthBump,
        farmerBump,
        {
          accounts: {
  ...
  async claim(
    ...
    const txSig = await this.farmProgram.instruction.claim(
      farmAuthBump,
      farmerBump,
      potABump,
      potBBump,
